...
public class Validator {
    ...
    private static List<String> condition = Arrays.asList("BrandNew", "LightlyUsed", "ModeratelyUsed", "HeavilyUsed", "DamagedOrDented", "NotWorking");
    ...
    public static boolean isUnderXChar(String stringValue, int x) {
        return stringValue.length() <= x && stringValue.length() > 0;
    }

    public static boolean isValidCondition(String cond){
        return condition.contains(cond);
    }
}
